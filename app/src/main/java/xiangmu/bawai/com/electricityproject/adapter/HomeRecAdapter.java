...
import xiangmu.bawai.com.electricityproject.bean.MiaoShaBean;
...
public class HomeRecAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public HomeRecAdapter(Context context, List<Titlebean.DataBean> dataBeen) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (itemViewType) {
            case VIEW_TYPE0:
                ...
                String picUrl = utr + dataBeen.get(0).getTag().get(0).getPicUrl();
            ...
            case VIEW_TYPE1:
                ...
                String picUrl1 = utr + dataBeen.get(1).getTag().get(0).getPicUrl();
...
//                            ToastUtils.showShortToast("没有更多");
                ...
                List<Titlebean.DataBean.TagBean> tag = dataBeen.get(1).getTag();
            ...
            case VIEW_TYPE3:
                ...
                String picUr22 =utr + dataBeen.get(9).getTag().get(0).getPicUrl();
